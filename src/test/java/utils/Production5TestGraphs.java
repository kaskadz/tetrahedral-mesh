...
public class Production5TestGraphs {
    public static TetrahedralGraph getProduction5CorrectLeftSide() {
    ...
    public static TetrahedralGraph getProduction5CorrectLeftSideWithAdditionalNodesOnRight() {
        Map<Integer, Pair<Float, Float>> nodesMap = new HashMap<>();
    ...
    public static TetrahedralGraph getProduction5CorrectLeftSideInGreaterGraph() {
        Map<Integer, Pair<Float, Float>> nodesMap = new HashMap<>();
    ...
    public static TetrahedralGraph getProduction5LeftSideWithBrokenLink() {
        Map<Integer, Pair<Float, Float>> nodesMap = new HashMap<>();
    ...
    public static TetrahedralGraph getProduction5LeftSideWithMissingNode() {
        Map<Integer, Pair<Float, Float>> nodesMap = new HashMap<>();
    ...
    public static TetrahedralGraph getProduction5LeftSideWithIncorrectCoordinates() {
        Map<Integer, Pair<Float, Float>> nodesMap = new HashMap<>();
